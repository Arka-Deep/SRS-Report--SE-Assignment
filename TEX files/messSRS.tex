...
\begin{document}
	...
	\begin{titlepage}
		...
		{\Large\textbf{MESS FOOD WASTAGE TRACKER AND}\\[0.2cm]
			\textbf{MANAGEMENT SYSTEM}}
		...
		\vspace{4.5cm}
		{\Large\textbf{Place Holder Cover page the actual cover has been created separately}}
		
		% Uncomment and modify if you have a university logo
...
%	\end{figure}
	...
	\begin{table}[H]
		...
		\begin{tabular}{|p{4.1cm}|c|c|c|c|}
			\hline
			\textbf{Condition / Action} & \textbf{R1} & \textbf{R2} & \textbf{R3} & \textbf{R4}\\
			\hline
			Expected attendance high? & Y & Y & N & N\\
			\hline
			Historical wastage high? & N & Y & N & Y\\
			\hline
			Increase preparation & Y & N & N & N\\
			\hline
			Maintain preparation & N & Y & Y & N\\
			\hline
			Reduce preparation & N & N & N & Y\\
			\hline
			Review data & N & Y & N & Y\\
			\hline
		\end{tabular}
